...
function GooFlow(bgDiv, property) {
  ...
  var name;
  name = Request["name"];
  var analysisName = decodeURIComponent(name);
  ...
  this.$title = analysisName; //流程图的名称
  ...
  this.t = {
    top: property.haveHead ? 28 : 3,
    left: property.haveTool ? 34 : 3
  };
...
GooFlow.prototype = {
  ...
  initDraw: function (id, width, height) {
    ...
    //绑定右键事件
    $(this.$draw).delegate(tmpClk, "contextmenu", {
      inthis: this
    }, function (e) {
  ...
  initGroup: function (width, height) {
    ...
    //绑定右键事件
    this.$group.delegate("GooFlow_area", "contextmenu", {
      inthis: this
    }, function (e) {
    ...
    this.$group.on("mousedown", {
      ...
      var ev = mousePosition(e),
        t = This.t; //t=getElCoordinate(This.$workArea[0]);
  ...
  initWorkForNode: function () {
    ...
    this.$workArea.delegate(".ico", "mousedown", {
      ...
      var vX = X - This.$nodeData[id].left * This.$scale,
        vY = Y - This.$nodeData[id].top * This.$scale;
      var isMove = false;
      document.onmousemove = function (e) {
        if (!e) e = window.event;
        var ev = mousePosition(e);
    ...
    //绑定双击功能
    this.$workArea.delegate(".ico", "dblclick", {
      inthis: this
    }, function (e) {
  ...
  calcStartEnd: function (n1, n2, scale) {
    ...
    var x11 = n1.left * scale,
      x12 = n1.left * scale + n1.width * scale,
      x21 = n2.left * scale,
      x22 = n2.left * scale + n2.width * scale;
    //结点2在结点1左边
    if (x11 >= x22) {
      X_1 = x11;
      X_2 = x22;
    ...
    var y11 = n1.top * scale,
      y12 = n1.top * scale + n1.height * scale,
      y21 = n2.top * scale,
      y22 = n2.top * scale + n2.height * scale;
    //结点2在结点1上边
    if (y11 >= y22) {
      Y_1 = y11;
      Y_2 = y22;
  ...
  calcPolyPoints: function (n1, n2, type, M, scale) {
    ...
    var N1 = {
      left: n1.left * scale,
      top: n1.top * scale,
      width: n1.width * scale,
      height: n1.height * scale
    };
    var N2 = {
      left: n2.left * scale,
      top: n2.top * scale,
      width: n2.width * scale,
      height: n2.height * scale
    };
    M = M * scale;
    //开始/结束两个结点的中心
    var SP = {
