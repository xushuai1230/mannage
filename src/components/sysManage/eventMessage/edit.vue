<template>
  <div class="edit" >
    ...
    <div class="editBoxTable">
        <el-form ref="form" :inline="true" :model="form"  class="form" size="mini" label-position="left"
          label-width="200px">
          <el-col :span="12" >
             <el-form-item label="事件">
                <el-select  v-model="form.eventId" auto-complete="off" size="mini" @visible-change="getEventMethod">
          ...
          <el-col :span="12">
           <el-form-item label="短信模板">
                <el-select  v-model="form.smsTemplateId" auto-complete="off" size="mini" @visible-change="getSMSTemplate" >
                <el-option key="0" value="请选择"></el-option>
                <el-option
          ...
          <el-col :span="12">
            <el-form-item label="邮件模板">
                  <el-select  v-model="form.emailTemplateId" auto-complete="off" size="mini" @visible-change="getMailTemplate" >
                <el-option key="0" value="请选择"></el-option>
                <el-option
          ...
          <el-col :span="12" >
             <el-form-item label="收件人">
                <el-select  v-model="form.userId" auto-complete="off" size="mini" @visible-change="getAddressee" >
                <el-option key="0" value="请选择"></el-option>
                <el-option
...
<script>
 ...
 export default {
  ...
  methods: {
    ...
    getData(){
      ...
      headers: {
        ...
        if(result.code == '0'){
          ...
          if(property[0].Receives != null  && property[0].Receives.length>0){
    ...
    //保存数据
    Save(){
      if(this.form.smsTemplateId==""||this.form.smsTemplateId=="请选择" || "undefined" == typeof(this.form.smsTemplateId)){
        this.$alert("短信模板为必填", '提示', {
          confirmButtonText: '确定',
            callback: action => {              
          }
        });
      }else if(this.form.emailTemplateId==""||this.form.emailTemplateId=="请选择" || "undefined" == typeof(this.form.emailTemplateId)){
        this.$alert("邮件模板为必填", '提示', {
          confirmButtonText: '确定',
            callback: action => {              
          }
        });
