...
import CstCooperativepartnerList from '../../partner/list'         // 后续将改成  PartnerList
import PartnerEdit               from '../../partner/edit'     
import CstCooperativeApprovalPending        from '../../partner/approvalPending'
import CstInformationList        from '../../customer/list'        // 后续将改成  CustomerList
...
import BasicInfo                 from '../../sysManage/basicInfo/list'
...
import SysBasicSiteEdit          from '../../sysManage/basicInfo/siteInformation/edit'
  ...
  export default{
    components:{
      ...
      CstUserList,CstUserEdit,                                          // 用户
      CstCooperativepartnerList,PartnerEdit,CstCooperativeApprovalPending, // 合作伙伴
      CstInformationList,CustomerEdit,CstInformationApprovalPending,    // 客户
      CstRoleList,CstRoleEdit,                                          // 角色
      EmailTemplateList,EmailTemplateEdit,                              // 邮件模板
      MenuList,                                                         // 栏目菜单
      EventFilterList,EventFilterEdit,                                  // 事件设置
      OnlineManageList,                                                 // 在线管理
      MessageList,                                                      // 消息
      EventMessageList,EventMessageEdit,                                // 事件消息
      SmsTemplateList,SmsTemplateEdit,                                  // 短信模板
      EmailSettingList,EmailSettingEdit,                                // 邮箱
      SmsSettingList,SmsSettingEdit,                                    // 短信
      ModifyPassword,                                                   // 修改密码
      BasicInfo,                                                        // 基本资料
      CustomMenu,                                                       // 自定义菜单
      Permission,                                                       // 设置——权限
      CompanyData,Govreatiuon,IndustryData,RegionalSearch,              // 图表
      ModularManageList,ModularManageEdit,                              // 站点管理——模块管理
      ModularPermission,                                                // 站点管理——模块权限
      OperationRecordList,                                              // 数据分析——操作记录
      OnlineTimeList,                                                   // 数据分析——在线时段 
      ExceptionRequestList,                                             // 数据分析——异常请求
      BusinessFlowList,BusinessFlowEdit,BusinessFlowProcess,BusinessFlowMessageSet,       // 工作流设置
      CstPreparationList,CstPreparationEdit,                            //报备管理
      BehaviorAnalysis,                                                 //行为分析
      CstJobList,CstJobEdit,                                            //职位 
      SiteInformation,SysBasicSiteEdit,                                 //站点信息
      Industry,IndustryEdit,                                            //行业
      MesSupplier, MesSupplierEdit,                                     //MES供应商
      ErpSupplier,ErpSupplierEdit,                                      //ERP供应商
      Province,ProvinceEdit,                                            //省
      City,CityEdit                                                     //市
    },
    data() {
      return{
